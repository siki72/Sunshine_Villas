        ...
        <main>
          ...
          <div className="jambian-infos-grid">
            <div className="situation">
              ...
              <p>
                On your doorstep, you will find miles of uninterrupted white
                sand beaming with activity There are plenty of restaurants,
                bars, water sports and boat trips to see wildlife in the sun.
                Our onsite restaurant and friendly staff will provide anything
                you need to make your stay enjoyable and memorable.
              </p>
            </div>
            <div
            ...
            <div className="about-Sunshine">
              ...
              <p>
                Sunshine Villas is located on 3 properties, around 400 m from
                each other. Breakfast is served in our middle - Kati Kati -
                property. Our villa layout was intentionally designed to ensure
                a more private experience. Our guests can enjoy a pleasant, 4
                minute walk on the beach to our restaurant location, and later
                return to their villa for a calm and quiet day by the beautiful
                Indian Ocean.
              </p>
            </div>
          </div>
